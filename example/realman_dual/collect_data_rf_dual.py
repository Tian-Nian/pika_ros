...
CAMERA_SERIALS = {
    'head': '218622270279',  # Replace with actual serial number
    'left_wrist': '218722270899',   # Replace with actual serial number
    'right_wrist': '218622272832',   # Replace with actual serial number
}
...
def collect(left_robot_controller, right_robot_controller, pipelines, index):
    ...
    try:
        ...
        return data_rf_dual.CollectData(right_status, right_gripper, left_status, left_gripper, imgs)
    except Exception as e:
